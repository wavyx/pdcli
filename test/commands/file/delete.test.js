...
const { default: FileDeleteCommand } =
  await import('../../../src/commands/file/delete.js')
...
describe('file delete', () => {
  ...
  it('deletes after confirmation', async () => {
    ...
    const stdout = await runCmd(FileDeleteCommand, ['5'])
  ...
  it('skips the prompt with --yes', async () => {
    ...
    await runCmd(FileDeleteCommand, ['5', '--yes'])
  ...
  it('aborts without deleting when declined', async () => {
    ...
    try {
      await expect(FileDeleteCommand.run(['5'])).rejects.toThrow(/abort/i)
    } finally {
