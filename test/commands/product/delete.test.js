...
const { default: ProductDeleteCommand } =
  await import('../../../src/commands/product/delete.js')
...
describe('product delete', () => {
  ...
  it('deletes after confirmation', async () => {
    ...
    const stdout = await runCmd(ProductDeleteCommand, ['42'])
  ...
  it('skips the prompt with --yes', async () => {
    ...
    await runCmd(ProductDeleteCommand, ['42', '--yes'])
  ...
  it('aborts without deleting when declined', async () => {
    ...
    try {
      await expect(ProductDeleteCommand.run(['42'])).rejects.toThrow(/abort/i)
    } finally {
